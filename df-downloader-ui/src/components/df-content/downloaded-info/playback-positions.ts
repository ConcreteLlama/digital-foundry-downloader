 ...
 *
 * Opening the player, closing it, and opening it again is an ordinary thing
 * to do, and each time it came back at zero - so anything longer than a few
 * minutes had to be found again by hand.
 *
